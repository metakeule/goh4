...
func docType(doctype string, objects ...Stringer) (t *Element) {
	t = NewElement(Tag("doc"), WithoutDecoration)
	t.Add(Html(doctype))
	t.Add(objects...)
	return
...
func XHTML1_0Frameset(objects ...Stringer) (t *Element) {
